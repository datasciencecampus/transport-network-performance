...
date-modified: 06/03/2024  # must be in MM/DD/YYYY format
...
[General Transit Feed Specification (GTFS)](https://gtfs.org/schedule/) feeds. This is
an important step to ensure quality in the inputs and reduce the computational cost of routing operations.
...
If your GTFS contains trips/routes that are still active across a range of dates including
