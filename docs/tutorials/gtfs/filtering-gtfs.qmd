...
If your GTFS contains a stop that is active across a range of dates including
the date you wish to restrict to, you will return the full range of that stop's
dates.
...
or where the speficiation is violated.
...
[Open Street Map tutorials](/docs/tutorials/osm/index.qmd)
